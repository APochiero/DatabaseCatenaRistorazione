DROP TRIGGER IF EXISTS ControllaConfezione1 ;
DELIMITER $$
CREATE TRIGGER ControllaConfezione1
BEFORE UPDATE ON Confezione FOR EACH ROW
...
IF (OLD.IdScaffale<>NEW.IdScaffale AND @quantipezzi+1 > @maxpezziscaffale) THEN
SIGNAL SQLSTATE '45000'
